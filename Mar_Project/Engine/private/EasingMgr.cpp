...
{
	return _float(-(fTargetPoint - fStartPoint) * cosf(fPassedTime / fTotalTime * (EASING_PI / 2)) + (fTargetPoint - fStartPoint) + fStartPoint);
}

_float CEasingMgr::sinfOut(_float fStartPoint, _float fTargetPoint, _float fPassedTime, _float fTotalTime)
{
	return _float((fTargetPoint - fStartPoint) * sinf(fPassedTime / fTotalTime * (EASING_PI / 2)) + fStartPoint);
}

_float CEasingMgr::sinfInOut(_float fStartPoint, _float fTargetPoint, _float fPassedTime, _float fTotalTime)
{
	return _float(-(fTargetPoint - fStartPoint) / 2 * (cosf(EASING_PI*fPassedTime / fTotalTime) - 1) + fStartPoint);
}
...
_float CEasingMgr::ElasticEaseOut(_float fStartPoint, _float fTargetPoint, _float fPassedTime, _float fTotalTime)
{
	...
	return _float((fTargetPoint - fStartPoint) * pow(2, -10 * fPassedTime) * sinf((fPassedTime * fTotalTime - s) * (2 * EASING_PI) / p) + (fTargetPoint - fStartPoint) + fStartPoint);
}
...
_float CEasingMgr::ElasticEaseIn(_float fStartPoint, _float fTargetPoint, _float fPassedTime, _float fTotalTime)
{
	...
	return _float(-((fTargetPoint - fStartPoint) * pow(2, 10 * (fPassedTime -= 1)) * sinf((fPassedTime * fTotalTime - s) * (2 * EASING_PI) / p)) + fStartPoint);
}
...
_float CEasingMgr::ElasticEaseInOut(_float fStartPoint, _float fTargetPoint, _float fPassedTime, _float fTotalTime)
{
	...
	if (fPassedTime < 1)
		return _float(-.5f * ((fTargetPoint - fStartPoint) * pow(2, 10 * (fPassedTime -= 1)) * sinf((fPassedTime * fTotalTime - s) * (2 * EASING_PI) / p)) + fStartPoint);
	return _float((fTargetPoint - fStartPoint) * pow(2, -10 * (fPassedTime -= 1)) * sinf((fPassedTime * fTotalTime - s) * (2 * EASING_PI) / p) * .5f + (fTargetPoint - fStartPoint) + fStartPoint);
}
