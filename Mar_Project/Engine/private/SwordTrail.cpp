...
HRESULT CSwordTrail::Initialize_Prototype(const _tchar*	szTextureFilePath , _uint iNumTrailBufferCount)
{
	...
	FAILED_CHECK(GetSingle(CGameInstance)->Add_Component_Prototype(0, L"Prototype_Trail", CTexture::Create(m_pDevice, m_pDeviceContext, szTextureFilePath)));

	m_pTexture = (CTexture*)GetSingle(CGameInstance)->Clone_Component(0, L"Prototype_Trail");
