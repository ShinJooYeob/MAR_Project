...
HRESULT CFontMgr::Initialize_FontMgr(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
...
HRESULT CFontMgr::Add_Font(const _tchar * pFontTag, const _tchar * pFontFilePath)
{
...
HRESULT CFontMgr::Render_Font(const _tchar * pFontTag, const _tchar * pText, _float2 vPosition, _fVector vColor,_float fAngle,_float2 vScale)
{
...
CExternFont * CFontMgr::Find_SpriteFont(const _tchar * pFontTag)
{
