#include "stdafx.h"
#include "..\public\TeethObj.h"
#include "Player.h"
#include "Terrain.h"



CTeethObj::CTeethObj(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CMapObject(pDevice,pDeviceContext)
{
}

CTeethObj::CTeethObj(const CTeethObj & rhs)
	: CMapObject(rhs)
{
}

HRESULT CTeethObj::Initialize_Prototype(void * pArg)
{
	FAILED_CHECK(__super::Initialize_Prototype(pArg));
	return S_OK;
}

HRESULT CTeethObj::Initialize_Clone(void * pArg)
{
...
_int CTeethObj::Update(_double fDeltaTime)
{
...
_int CTeethObj::LateUpdate(_double fDeltaTime)
{
...
_int CTeethObj::Render()
{
	...
	for (_uint i = 0; i < NumMaterial; i++)
	{
		...
		FAILED_CHECK(m_pModel->Render(m_pShaderCom, 14, i));
	}
...
HRESULT CTeethObj::SetUp_Components()
{
...
void CTeethObj::Add_JumpPower(_float power)
{
...
CTeethObj * CTeethObj::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, void * pArg)
{
	CTeethObj*	pInstance = new CTeethObj(pDevice, pDeviceContext);

	if (FAILED(pInstance->Initialize_Prototype(pArg)))
	{
		MSGBOX("Failed to Created CTeethObj");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CTeethObj::Clone(void * pArg)
{
	CTeethObj*	pInstance = new CTeethObj(*this);
