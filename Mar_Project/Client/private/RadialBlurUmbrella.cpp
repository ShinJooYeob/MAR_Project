#include "stdafx.h"
#include "..\public\RadialBlurUmbrella.h"
#include "Player.h"



CRadialBlurUmbrella::CRadialBlurUmbrella(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CUI(pDevice,pDeviceContext)
{
}

CRadialBlurUmbrella::CRadialBlurUmbrella(const CRadialBlurUmbrella & rhs)
	:CUI(rhs)
{

}

HRESULT CRadialBlurUmbrella::Initialize_Prototype(void * pArg)
{
...
HRESULT CRadialBlurUmbrella::Initialize_Clone(void * pArg)
{
...
_int CRadialBlurUmbrella::Update(_double fDeltaTime)
{
	...
	if (!pPlayer || pPlayer->Get_UmbrellaIntro() <= 0)
	{
		m_bNeedToDraw = false;
		return 0;
	}
	...
	m_bNeedToDraw = true;
	m_DashPower = pPlayer->Get_UmbrellaIntro();
	

	return _int();
}

_int CRadialBlurUmbrella::LateUpdate(_double fDeltaTime)
{
...
_int CRadialBlurUmbrella::Render()
{
	if (__super::Render() < 0)
		return -1;
...
_int CRadialBlurUmbrella::LightRender()
{
...
void CRadialBlurUmbrella::Chage_TextureIndex(_uint iIndex)
{
...
HRESULT CRadialBlurUmbrella::SetUp_Components()
{
...
CRadialBlurUmbrella * CRadialBlurUmbrella::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, void * pArg)
{
	CRadialBlurUmbrella*	pInstance = new CRadialBlurUmbrella(pDevice, pDeviceContext);

	if (FAILED(pInstance->Initialize_Prototype(pArg)))
	{
		MSGBOX("Failed to Created CRadialBlurUmbrella");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CRadialBlurUmbrella::Clone(void * pArg)
{
	CRadialBlurUmbrella*	pInstance = new CRadialBlurUmbrella(*this);
