...
class CHandyGirlBullet final :public CMonsterWeapon
{
public:
...
private:
	CHandyGirlBullet(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CHandyGirlBullet(const CHandyGirlBullet& rhs);
	virtual ~CHandyGirlBullet() = default;
...
public:
	static CHandyGirlBullet* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg = nullptr);
