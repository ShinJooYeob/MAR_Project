...
class CStage3_SpwanExecutor final :public CMapObject
{
public:
...
private:
	explicit CStage3_SpwanExecutor(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CStage3_SpwanExecutor(const CStage3_SpwanExecutor& rhs);
	virtual ~CStage3_SpwanExecutor() = default;
...
public:
	static CStage3_SpwanExecutor* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg = nullptr);
